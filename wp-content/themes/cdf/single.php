...
if ( is_a( $next_post , 'WP_Post' ) ) {
	...
	$context['nextpost'] = '<li class="post-nav__link post-nav__link--next"><a href="' . $next . '">' . '<span>Next Post</span> <i class="fa fa-angle-right"></i>' . '</a></li>';
}

$prev_post = get_next_post();
if ( is_a( $prev_post , 'WP_Post' ) ) {
	$prev = get_permalink( $prev_post->ID );
	$context['prevpost'] = '<li class="post-nav__link post-nav__link--prev"><a href="' . $prev . '">' . '<i class="fa fa-angle-left"></i> <span>Previous Post</span>' . '</a>';
}
